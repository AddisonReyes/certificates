...
export function certificateLabelFromId(id: string) {
  let label = id
    .replaceAll("+", " plus ")
...
export function normalizeCertificateSearchText(s: string) {
  return s.trim().toLowerCase();
}

export function certificateSearchKey(id: string, label: string) {
  return normalizeCertificateSearchText(
    [
      id,
      label,
